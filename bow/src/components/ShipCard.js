...
class ShipCard extends PureComponent {
  ...
  render() {
    ...
    return (
      <div key={ship.id} className="card" style={{ borderRadius: '5px', marginBottom: '2.5em' }}>
        ...
        <div className="card-content" style={{ paddingTop: '0px' }}>
          ...
          <p className="subtitle is-6">
            in <Link className="has-text-link">{ship.port_id}</Link>
          </p>
          <p className="subtitle is-6"><b>IMO: </b>{ship.imo}</p>
          <p className="subtitle is-6"><b>Propulsion: </b>{ship.propulsion_id}</p>
          ...
          <p className="subtitle is-6">
            ...
            Deadline: <a className="has-text-link">10/10/2021 </a>
          </p>
        </div>

        <footer className="card-footer">
          <Link className="card-footer-item has-text-success" to={`/ship/${ship.id}`}>
            Learn More
          </Link>
        </footer>
      </div>
